...
function RootRouter() {
  ...
  if (path === '/mugsywebsite/treasure-hunt/participant-signin' || path === '/mugsywebsite/treasure-hunt/participant-signin/' || path === '/treasure-hunt/participant-signin' || path === '/treasure-hunt/participant-signin/') {
    return (
      <SolanaWalletProvider>
        <TreasureHuntRegistration />
      </SolanaWalletProvider>
